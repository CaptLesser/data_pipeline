...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Compute per-symbol metrics and baseline classifications for gainers cohort")
    ...
    p.add_argument("--series-output", default="gainers_metrics_series.csv", help="Output CSV path for metrics time series")
