"""Fetch 30-day OHLCVT history for top gainers and save to CSV.

Reads symbols from a cohort CSV (default: habitual_gainers.csv) and
...
# --- Defaults / Env ---
DEFAULT_INPUT_CSV = os.getenv("GAINERS_CSV", "habitual_gainers.csv")
DEFAULT_OUTPUT_CSV = os.getenv("GAINERS_HISTORY_OUTPUT_CSV", "gainers_30day_history.csv")
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Fetch 30-day OHLCVT history for gainers cohort")
    ...
    # Ensure we only fetch unique symbols
